...
let diaTela = diaAtual;


function carregar(dia = diaAtual) {
...
window.onload = function() {
    ...
    var diaSem = document.getElementById('dia-semana');
    diaSem.style.cursor = 'pointer';

    diaSem.onclick = function() {
        let proximoDia = (diaTela + 1) % 7;
        carregar(proximoDia);
    };

    diaSem.onmouseleave = function() {
        carregar(diaAtual);
    };
};